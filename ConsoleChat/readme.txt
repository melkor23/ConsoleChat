...
| |___| (_) | | | \__ \ (_) | |  __/ | |____| |  | |/ ____ \| |   
 \_____\___/|_| |_|___/\___/|_|\___|  \_____|_|  |_/_/    \_\_|   
                                                                        
========================================================================

Implementación tanto de servidor como cliente de un chat utilizando websockets con C# y .Net Core 3.1
...
Si no hay ningun servidor escuchando en ese puerto se inicia en modo servidor
Si el puerto es disponible se pone en modo Cliente y se conecta
...
Se injecta en los servicios (Cliente y servidor) la interfaz de gestion de la entrada-salida y la gestión de los strings de textos que se muestran por pantalla.

A ambos servicios le injectamos la interfaz "ILecturaEscritura", en la que delegamos la entrada-salida por pantalla
Tambien injectamos los ITextosConsola que son los textos que se mostraran por pantalla, almacenados en el archivo textos.json
...
Cada vez que hay una conexion, el servidor se guarda en un List<WebSocket> los datos de la conexion y cada vez que llega un mensaje el servidor lo distribuye por las conexiones que estan activas, menos por la que se envio el proipio mensaje. 
Al desconectarse un cliente se borra de la lista, al informar al servidor. Todos estos eventos se asignan al crear el socket tanto en modo servidor como en modo
